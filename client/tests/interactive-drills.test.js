...
describe('InteractiveDrillSystem', () => {
  ...
  describe('Initialization', () => {
    ...
    it('should setup event listeners for drill practice', () => {
      ...
      expect(addEventListenerSpy).toHaveBeenCalledWith('startDrillPractice', expect.any(Function));
  ...
  describe('Drill Navigation', () => {
    ...
    it('should display current drill correctly', () => {
      ...
      expect(levelElement.textContent).toBe(`Level ${drillSystem.currentDrill.level}`);
    });
  ...
  describe('Answer Checking Process', () => {
    ...
    it('should handle empty input', () => {
      ...
      expect(showFeedbackSpy).toHaveBeenCalledWith('Please enter an answer', 'incorrect', '❌');
    });
  ...
  describe('Feedback System', () => {
    ...
    it('should hide feedback', () => {
      ...
      expect(drillSystem.feedbackArea.classList.contains('visible')).toBe(false);
    });
  ...
  describe('Progress Tracking', () => {
    ...
    it('should save progress to localStorage', () => {
      ...
      expect(localStorage.setItem).toHaveBeenCalledWith('drillProgress', expect.any(String));
    });
  ...
  describe('Voice Input Integration', () => {
    ...
    it('should show error when voice input not available', () => {
      ...
      expect(showNotificationSpy).toHaveBeenCalledWith('Voice input not available', 'error');
    });
  });
