...
describe('DarkModeSystem', () => {
  ...
  describe('Theme Preference Management', () => {
    ...
    it('should store preference in localStorage', () => {
      ...
      expect(localStorage.setItem).toHaveBeenCalledWith('dark-mode-preference', 'true');

      darkModeSystem.storePreference(false);
      expect(localStorage.setItem).toHaveBeenCalledWith('dark-mode-preference', 'false');
    });
  ...
  describe('Advanced Theme Management', () => {
    ...
    it('should reset to system preference', () => {
      ...
      expect(localStorage.removeItem).toHaveBeenCalledWith('dark-mode-preference');
    });
  ...
  describe('Edge Cases', () => {
    ...
    it('should handle theme application with animation', () => {
      ...
      const removeIconSpy = vi.spyOn(darkModeSystem.themeIcon.classList, 'remove');
