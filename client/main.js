...
class BulgarianVoiceCoach {
  constructor() {
    ...
    this.currentVoiceProfile = localStorage.getItem('voiceProfile') || 'natural';
  ...
  async startGrammarPractice(grammarId) {
    try {
      ...
      if (drills.length > 0) {
        ...
        promptP.style.cssText = 'font-weight: 500; margin-bottom: 1rem; color: #333;';
        promptP.textContent = drill.prompt;
        contentBox.appendChild(promptP);

        // Create answer
        const answerDiv = document.createElement('div');
        answerDiv.style.cssText = 'color: #28a745; font-weight: 600; font-size: 1.1rem;';
        ...
        instruction.style.cssText = 'color: #666; font-size: 0.9rem; margin-top: 1rem;';
        instruction.textContent = '💬 Try saying this out loud, then start your conversation!';
        ...
        closeBtn.addEventListener('click', () => {
          ...
          defaultDiv.style.cssText = 'text-align: center; color: #999; padding: 2rem;';
