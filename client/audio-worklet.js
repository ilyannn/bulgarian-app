...
class VoiceProcessor extends AudioWorkletProcessor {
    ...
    process(inputs, outputs, parameters) {
        ...
        for (let i = 0; i < blockSize; i++) {
            ...
            this.levelSmoother = this.levelSmoother * this.levelSmoothingFactor + 
        ...
        if (this.frameCounter % 512 === 0) {  // ~10-20 times per second
    ...
    getAvailableSamples() {
        return (this.bufferWriteIndex - this.bufferReadIndex + this.audioBuffer.length) % 
