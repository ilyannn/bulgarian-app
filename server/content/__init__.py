...
def get_grammar_item(grammar_id: str) -> Optional[Dict[str, Any]]:
    """
    ...
    return {
        "bg.no_infinitive.da_present": {
            ...
            "examples": [
                ...
                {"wrong": "Мога говоря български.", "right": "Мога да говоря български."}
            ],
            "drills": [
                {
                    "type": "transform",
        ...
        "bg.definite.article.postposed": {
            ...
            "examples": [
                {"wrong": "стол", "right": "столът", "context": "когато говорим за конкретен стол"},
                {"wrong": "the книга", "right": "книгата", "context": "определена книга"}
            ],
            "drills": [
                {
                    "type": "transform",
        ...
        "bg.future.shte": {
            ...
            "examples": [
                ...
                {"wrong": "Следващата седмица пътувам.", "right": "Следващата седмица ще пътувам."}
            ],
            "drills": [
                {
                    "type": "transform",
        ...
        for grammar_id, progress in self.user_progress[user_id].items():
            if grammar_id in grammar_pack:
                ...
                if progress["last_seen"]:
                    interval = intervals[min(progress["interval_index"], len(intervals) - 1)]
